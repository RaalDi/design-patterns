 ...
 * 
 * Filter - Filter which will performs certain task prior or after execution of request by request
 * handler.
 * 
 * Filter Chain - Filter Chain carries multiple filters and help to execute them in defined order on
 * target.
 * 
